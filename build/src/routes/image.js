...
const fileSaver_1 = __importDefault(require("../middlewares/fileSaver"));
const UploadControllers_1 = require("../controllers/UploadControllers");
const router = (0, express_1.Router)();
router.post("/multi-upload", fileSaver_1.default.array("files"), UploadControllers_1.handleMessage);
